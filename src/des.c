...
int FP[] = {40, 8,  48, 16, 56, 24, 64, 32, 39, 7,  47, 15, 55, 23, 63, 31, 38, 6,  46, 14, 54, 22,
...
void create16Keys() {
    ...
    const char temp[] = "0001001100110100010101110111100110011011101111001101111111110001";
